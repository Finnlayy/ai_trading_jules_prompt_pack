...
from app.services.ai_mock import ai_review_instance
...
def process_signal(payload: M8Payload):
    """
    Main orchestration loop integrating AI Review -> Risk Engine -> Simulation Broker -> Journaling.
    """

    # 1. AI Context Review (Non-execution)
    ai_review = ai_review_instance.review_signal(payload)
